...
export default function AddVehicle() {
  ...
  return (
    <div className="min-h-screen bg-[#fcf9f8] flex flex-col pb-20">
      <AppHeader 
        title={<span className="text-navy font-bold tracking-wide">ADD VEHICLE</span>} 
      ...
      <main className="flex-1 w-full max-w-xl mx-auto px-5 pt-8 pb-12">
        ...
        <div className="flex flex-col items-center mb-10">
          <motion.div
            className="w-full max-w-[340px] aspect-[2.5/1] rounded-lg flex flex-col items-center justify-center relative overflow-hidden bg-white border-2 border-[#1c1b1b]"
          ...
          >
            {/* Blue strip */}
            <div className="absolute left-0 top-0 bottom-0 w-3 bg-navy"></div>
            
            <div className="font-body text-[10px] font-bold tracking-[0.08em] text-on-surface-muted/50 absolute top-2 uppercase">
              ROADLINK DIGITAL IDENTITY
            </div>
            
            <div className={`font-mono text-[32px] md:text-[38px] whitespace-nowrap font-bold tracking-[0.1em] uppercase transition-opacity duration-300 ${plate ? 'text-on-surface' : 'text-[#1c1b1b] opacity-30'}`}>
              {plate || 'MH 12 AB 1234'}
            </div>
            
            <div className="flex gap-2 absolute bottom-2 opacity-40">
              <Shield size={14} className="text-[#1c1b1b]" />
              <div className="w-[14px] h-[14px] bg-[#1c1b1b]" style={{
                maskImage: 'url("data:image/svg+xml,%3Csvg viewBox=\'0 0 24 24\' fill=\'none\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M3 3H11V11H3V3ZM5 5V9H9V5H5ZM13 3H21V11H13V3ZM15 5V9H19V5H15ZM3 13H11V21H3V13ZM5 15V19H9V15H5ZM13 13H16V16H13V13ZM18 13H21V16H18V13ZM13 18H16V21H13V18ZM18 18H21V21H18V18ZM16 16H18V18H16V16Z\' fill=\'currentColor\'/%3E%3C/svg%3E")',
                WebkitMaskImage: 'url("data:image/svg+xml,%3Csvg viewBox=\'0 0 24 24\' fill=\'none\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M3 3H11V11H3V3ZM5 5V9H9V5H5ZM13 3H21V11H13V3ZM15 5V9H19V5H15ZM3 13H11V21H3V13ZM5 15V19H9V15H5ZM13 13H16V16H13V13ZM18 13H21V16H18V13ZM13 18H16V21H13V18ZM18 18H21V21H18V18ZM16 16H18V18H16V16Z\' fill=\'currentColor\'/%3E%3C/svg%3E")',
                maskSize: 'contain',
                ...
                <div className="bg-white/50 p-4 rounded-xl space-y-4 border border-outline-light/50 shadow-sm">
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col pr-4">
                      <span className="font-body text-xs font-bold tracking-wider uppercase text-on-surface">SHOW MY NAME PUBLICLY</span>
                      <span className="text-[11px] text-on-surface-muted font-body mt-0.5">Visible when your plate is scanned</span>
                    </div>
                  ...
                  <div className="flex gap-3 items-start p-3 bg-white rounded-lg border border-outline-light/40 shadow-card">
                    ...
                    <p className="font-body text-[12px] text-on-surface-muted leading-relaxed">
                        Your phone number and sensitive PII are always encrypted and never shown. Privacy is our administrative mandate.
                    </p>
                  </div>
                </div>
              </motion.div>
