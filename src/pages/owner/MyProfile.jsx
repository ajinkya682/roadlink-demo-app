  ...
  return (
    <div className="min-h-screen bg-[#fcf9f8] text-[#1c1b1b] font-body pb-24">
      ...
      <main className="max-w-2xl mx-auto px-4 pt-6 space-y-8">
        ...
        >
          <div className="relative group cursor-pointer">
            <div className="w-28 h-28 bg-[#1B4B8F] rounded-[2rem] flex items-center justify-center shadow-lg transition-transform group-active:scale-95">
              <span className="font-display text-[40px] font-bold text-white">{user.avatar}</span>
            </div>
          ...
          <div className="text-center">
            <h2 className="font-display text-[24px] font-semibold text-[#1c1b1b]">{user.name}</h2>
            <p className="font-body text-[14px] text-[#737782]">Member since {user.joinedDate}</p>
          </div>
        </motion.div>
        ...
        >
          <h3 className="font-display text-[20px] font-semibold text-[#1c1b1b]">Personal Information</h3>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="font-body text-[12px] text-[#737782] mt-1.5 ml-1">Contact support to change your primary phone number.</p>
            </div>
            ...
            <div className="relative">
              ...
              />
              <Mail size={20} className="absolute right-4 top-10 text-[#737782]" />
            </div>
            ...
            <div className="relative">
              ...
              />
              <MapPin size={20} className="absolute right-4 top-10 text-[#737782]" />
            </div>
          </div>
        </motion.section>
